...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuespedes() {
		String obj = "";
		if(txtFechaN.getDate()!= null && !txtNombre.equals(obj) && !txtApellido.equals(obj)&& !txtTelefono.equals(obj)) {
			...
			Huespedes huespedes = new Huespedes(nreserva, txtNombre.getText(), txtApellido.getText(),fechaN,
